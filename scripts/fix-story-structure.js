...
async function fixStoryStructure() {
  try {
    ...
    // Create the proper story structure using the existing 'page' component
    const storyContent = {
      component: "page",  // Use the existing root page component
      body: [
        // Hero Section
        {
          component: "Hero",
    ...
    // Update the story
    console.log('\n🔄 Updating home story with proper schema structure...');
    ...
    // Log sections added
    console.log('\n📋 Story structure fixed with proper schemas:');
    console.log(`📦 Root component: ${storyContent.component}`);
    console.log(`📋 Body blocks: ${storyContent.body.length}`);
    storyContent.body.forEach((section, index) => {
      console.log(`   ${index + 1}. ${section.component} - ${section.title || 'No title'}`);
    });

    console.log('\n✅ Perfect! Now you have:');
    console.log('- ✅ Proper root "page" component');
    console.log('- ✅ All components match existing schemas');
    console.log('- ✅ Body array with all 11 sections');
    console.log('- ✅ No more "out of schema" errors');
    console.log('- ✅ Local image paths for manual upload');
